...
class Window(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        grid.addWidget(btn6, 2, 1)  # Добавляем кнопку btn6 в сетку на третьей строке и втором столбце
        grid.addWidget(btn7, 3, 2)  # Добавляем кнопку btn7 в сетку на четвёртой строке и третьем столбце
        grid.addWidget(btn8, 4, 3)  # Добавляем кнопку btn8 в сетку на пятой строке и четвертом столбце
